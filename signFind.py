...
def check_signature_improved(pdf_path):
    ...
    # Örneğin:
    x1, y1 = 1400, 1200  # Bu değerleri manuel olarak belirlemelisiniz!
    x2, y2 = 2000, 1450  # Bu değerleri manuel olarak belirlemelisiniz!
    # *******************************************************************
...
if __name__ == "__main__":
    pdf_path = "signed.pdf" # PDF dosyanızın adı
